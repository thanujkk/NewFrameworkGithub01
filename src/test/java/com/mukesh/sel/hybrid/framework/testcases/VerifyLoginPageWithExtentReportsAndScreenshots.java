...
public class VerifyLoginPageWithExtentReportsAndScreenshots {
	...
	public void setUp() {
		...
		report = new ExtentReports("D:\\LearningAndTraining\\Selenium\\eclipse-oxygen-workspace-02\\com.mukesh.sel.hybrid.framework\\Reports\\LoginPageReport.html", true);
		logger = report.startTest("Verify Login Page With Extent Reports");
